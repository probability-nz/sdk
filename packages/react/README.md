...
React SDK for building [Probability](https://probability.nz) plugins. Plugins are web apps that can help with gameplay, act as an AI opponent, manage decks, enforce rules, etc.
